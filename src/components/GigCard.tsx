    ...
    >
      ...
      <div className="mt-2 sm:mt-3 flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          <div className="mt-1 line-clamp-2 text-xs sm:text-sm font-bold">{gig.title}</div>
        </div>
      ...
      <div className="mt-2 sm:mt-3 flex items-center justify-between text-xs sm:text-sm">
        <div className="flex items-center gap-2 text-black/60 min-w-0">
          ...
          <div className="leading-tight min-w-0">
            <div className="font-semibold text-black truncate">{gig.seller.name}</div>
            <div className="text-[10px] sm:text-xs truncate">{gig.seller.title}</div>
          </div>
        </div>
